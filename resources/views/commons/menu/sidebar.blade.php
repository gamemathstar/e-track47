    ...
    @auth
        <ul>
            ...
            @if($user->isFacilitator())
                <li>
                    <a href="{{ route('delivery.awaiting.verification') }}"
                       class="side-menu {{ Request::is('delivery/tracking/awaiting*') ? 'side-menu--active' : '' }}">
            ...
            @if($user->isCoordinator() || $user->isDeputyCoordinator())
                <li>
                    <a href="{{ route('delivery.coordinator.final-review') }}"
                       class="side-menu {{ Request::is('delivery/coordinator/final-review*') ? 'side-menu--active' : '' }}">
