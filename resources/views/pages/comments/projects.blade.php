                    ...
                    <a href="{{ route('public.project.details',[$commitment->id]) }}">
                        <div class="p-5">
                            <div class="h-40 2xl:h-56 image-fit">
                                <img alt="{{ $commitment->name }}" class="rounded-md"
                                     src="{{$commitment->img_url?asset('uploads/'.$commitment->img_url):asset('dist/images/preview-3.jpg')}}">
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3 flex-1">
                                            ...
                                            <div
                                                    class="text-slate-500 text-xs sm:text-sm">{{  \Carbon\Carbon::parse($comment->created_at)->format('jS F Y')  }}</div>
