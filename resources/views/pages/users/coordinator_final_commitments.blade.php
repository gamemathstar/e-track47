...
@section('content')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <div class="mr-auto ml-3">
            <a href="{{ route('delivery.coordinator.final-review') }}" class="text-primary text-sm hover:underline">← Back to sectors</a>
        ...
        <div class="col-span-12">
                ...
                <table class="table table-report mt-2">
                    ...
                    @foreach($performanceTrackings as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('delivery.coordinator.final-review.commitment', $row->id) }}"
            ...
            @else
                <div class="box p-8 text-center text-slate-500">
                    <p>No commitments in this sector have submissions awaiting your final review.</p>
                </div>
            @endif
        </div>
    </div>
