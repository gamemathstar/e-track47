    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <span class="text-white text-lg ml-3"> JSEPM </span>
            </a>
            <div class="my-auto">
                <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{asset('jigawa3_map.png')}}">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="intro-x flex text-slate-600 dark:text-slate-500 text-xs sm:text-sm mt-4">
                        <div class="flex items-center mr-auto">
                            <input type="checkbox" class="form-check-input border mr-2" id="remember" {{ old('remember') ? 'checked' : '' }}>
