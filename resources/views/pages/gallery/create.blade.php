...
@section('content')
    ...
    <div class="intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            ...
                            <textarea id="caption" 
                                      ...
                                      class="form-control" 
                                      rows="4"
                                      placeholder="Enter image description or caption (optional)">{{ old('caption') }}</textarea>
                            <div class="text-xs text-gray-500 mt-1">
                        ...
                        <div class="col-span-12 lg:col-span-6">
                            ...
                            <div class="text-xs text-gray-500 mt-1">
                                Active images will be visible in the public gallery
                            </div>
                            @error('status')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-span-12">
                            <div class="flex justify-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="w-4 h-4 mr-2" data-lucide="upload"></i>
                                    Upload Image
                                </button>
                            </div>
                        </div>
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="box p-5">
                <h3 class="text-lg font-medium mb-4">Image Preview</h3>
