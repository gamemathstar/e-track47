...
<div class="content content--top-nav">
    <div class="grid grid-cols-12 gap-6" style="padding: 20px;">
        <div class="col-span-12 2xl:col-span-12">
            <div
                class="relative min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8">
                ...
                <div class="max-w-7xl mx-auto p-6 pb-8 lg:p-8" style="padding: 20px;">
                    ...
                    <div class="max-w-4xl mx-auto mb-16">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div
                                class="w-full bg-gradient-to-br from-blue-600 to-indigo-700 p-8 flex items-center justify-center">
                            ...
                            <div class="w-full p-8 md:p-12">
                                <div class="mb-6">
                                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Welcome
                                        Message</h2>
                                ...
                                <div class="prose prose-lg dark:prose-invert max-w-none">
                                    <p class="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
                                        As part of our administration's commitment to transparency and accountability, I
                                        am pleased to introduce the launch of our new Project Monitoring App. This
                                        innovative tool will enable real-time tracking and oversight of our state's
                                        infrastructure and development projects, ensuring that they are completed on
                                        time, within budget, and to the highest standards of quality.
                                    </p>
                                    <p class="text-gray-700 dark:text-gray-300 leading-relaxed text-lg mt-4">
                                        The app will provide citizens with easy access to project information, progress
                                        updates, and feedback mechanisms, fostering greater public engagement and trust
                                        in our governance.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 p-16">
                        ...
                        <div
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Real-time
                                    Monitoring</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-400 pl-5">Track project progress in real-time with
                                live updates and comprehensive reporting.</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 dark:text-gray-400 pl-5">Full visibility into project details,
                                budgets, and timelines for public accountability.</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 dark:text-gray-400 pl-5">Citizen feedback and engagement mechanisms
                                for better project outcomes.</p>
                        </div>
                    </div>

                    <!-- Call to Action -->
                    <div class="text-center" style="background-color: #008751; padding: 20px;color">
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8">
                            ...
                            <p class="text-blue-100 mb-6">Discover the infrastructure and development projects
                                transforming Jigawa State</p>
                            @auth
                                <a href="{{ url('/home') }}"
