...
{
    public static function build(array $preview, array $meta, User $user, array $importStats = [], string $uploadMode = 'structure'): array
    {
        $submittedAt = now();
        $rows = $preview['rows'] ?? [];
        ...
        $quarterlyAverages = $uploadMode === 'actuals'
    ...
    public static function quarterlyActualAverages(array $rows): array
    {
        $quarters = [
